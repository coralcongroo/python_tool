...
def main():
    ...
    p_push.add_argument("--fps",        type=int,   default=30,
                        help="目标帧率（default: 30）")
    p_push.add_argument("--leds",       type=int,   default=462,
    ...
    p_push.add_argument("--brightness", type=int,   default=128,
                        help="亮度 0-255（default: 128）")
    p_push.add_argument("--r",          type=int,   default=255, help="主色 R")
    p_push.add_argument("--g",          type=int,   default=100, help="主色 G")
    p_push.add_argument("--b",          type=int,   default=0,   help="主色 B")
    p_push.add_argument("--r2",         type=int,   default=0,   help="渐变终止色 R")
    p_push.add_argument("--g2",         type=int,   default=0,   help="渐变终止色 G")
    p_push.add_argument("--b2",         type=int,   default=255, help="渐变终止色 B")
    p_push.add_argument("--tail",       type=int,   default=20,
                        help="chase 模式拖尾长度（default: 20）")
    p_push.add_argument("--cooling",    type=int,   default=55,
                        help="fire 模式冷却速率（default: 55）")
    p_push.add_argument("--sparking",   type=int,   default=120,
